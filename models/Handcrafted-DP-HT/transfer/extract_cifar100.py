...
np.save("transfer/features/cifar100_resnext_train_lt.npy", features_train)
np.save("transfer/features/cifar100_resnext_test_lt.npy", features_test)
np.save("transfer/features/cifar100_resnext_mean_lt.npy", mean_cifar100)
np.save("transfer/features/cifar100_resnext_var_lt.npy", var_cifar100)
