...
from private_train_utils import get_device, train, test
from data import get_data
from dp_utils import ORDERS, get_privacy_spent, get_renyi_divergence
from log import Logger


def main(feature_path=None, seed=1, batch_size=2048, mini_batch_size=256,
    ...
    for epoch in range(0, epochs):
        ...
        train_loss, train_acc = train(model, cls_num_list, per_cls_weights, train_loader, optimizer, n_acc_steps=n_acc_steps)
